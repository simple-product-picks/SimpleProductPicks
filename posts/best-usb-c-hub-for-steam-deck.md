# Best USB C Hub For Steam Deck 2026
...
A Deck hub only has a few jobs, so we scored on exactly those: HDMI for TV and monitor output, USB-C power delivery to keep the Deck charged while docked, USB-A ports for controllers and peripherals, and Ethernet for stable downloads and online play. We also weighed build, portability and fit. Dock listings change often, so follow the links through to Amazon and check the live price before you plan a TV setup around one. Playing away from the mains too? Our [best power bank for Steam Deck](best-power-bank-for-steam-deck.html) guide covers charging on the move.
