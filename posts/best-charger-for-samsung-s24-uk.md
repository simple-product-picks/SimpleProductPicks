...
**Cons**
- ✗ Only two of the three ports are USB-C, so a third USB-C device has to wait
...
**SPP Score: 8.2 / 10** - 100W output, compact GaN build. Our pick for maximum capability.
