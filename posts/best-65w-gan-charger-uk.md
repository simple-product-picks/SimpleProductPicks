...
- ✓ GaN design keeps it noticeably smaller than a comparable traditional laptop charger
- ✓ 67W output gives headroom to fast-charge a laptop alongside smaller devices
...
**SPP Score: 8.3 / 10** - 65W output, two-port design, compact GaN build. Our value pick.
...
**SPP Score: 8.5 / 10** - 65W output, compact GaN build. Our pick for maximum capability.
...
- ✓ Single dedicated USB-C port means no shared-output speed penalty
- ✓ Pocket-friendly footprint that is easy to pack for travel
